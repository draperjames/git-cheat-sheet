...
##### Stages new and modified, without deleted, current changes to the next commit:
```
$ git add .
```
...
$ git add -u
```
##### Satges all changes modifications and deletions, equivalent to `git add .; git add -u`:
